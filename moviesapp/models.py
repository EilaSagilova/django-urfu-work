...
class Movie(models.Model):
    ...
    directors = models.ManyToManyField(Actor, verbose_name='Режиссеры', related_name='film_actor')
    ...
    world_priemere = models.DateField("Премьера в мире", default=2019)
    budget = models.PositiveIntegerField("Бюджет", default=0, help_text='Указывать сумму в долларах')
    fees_in_usa = models.PositiveIntegerField("Сборы в сша", default=0, help_text='Указывать сборы в сша')
    fees_in_world = models.PositiveIntegerField("Сборы в сша", default=0, help_text='Указывать сборы в мире')
    category = models.ForeignKey(Category, verbose_name = 'Категория', on_delete=models.SET_NULL, null=True)
    url = models.SlugField(max_length=130, default=True)
